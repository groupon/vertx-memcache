...
/**
 * A MessageCodec for passing the DeleteCommandResponse in Vertx
 *
 * @author Stuart Siegrist (fsiegrist at groupon dot com)
 * @since 3.1.0
 */
public class DeleteCommandResponseCodec implements MessageCodec<DeleteCommandResponse, DeleteCommandResponse> {
    ...
    public DeleteCommandResponse decodeFromWire(int i, Buffer buffer) {
        ...
        return new DeleteCommandResponse.Builder()
                .setStatus(status)
                .setMessage(message)
                .setData(data)
                .build();
    ...
    @Override
    public DeleteCommandResponse transform(DeleteCommandResponse commandResponse) {
