...
/**
 * A MessageCodec for passing the StoreCommandResponse in Vertx
 *
 * @author Stuart Siegrist (fsiegrist at groupon dot com)
 * @since 3.1.0
 */
public class StoreCommandResponseCodec implements MessageCodec<StoreCommandResponse, StoreCommandResponse> {
    ...
    public StoreCommandResponse decodeFromWire(int i, Buffer buffer) {
        ...
        return new StoreCommandResponse.Builder()
                .setStatus(status)
                .setMessage(message)
                .setData(data)
                .build();
    ...
    @Override
    public StoreCommandResponse transform(StoreCommandResponse commandResponse) {
