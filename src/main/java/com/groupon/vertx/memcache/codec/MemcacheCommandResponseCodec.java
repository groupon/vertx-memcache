 ...
 * @since 3.1.0
 */
public class MemcacheCommandResponseCodec implements MessageCodec<MemcacheCommandResponse, MemcacheCommandResponse> {
    @Override
    ...
    @Override
    public MemcacheCommandResponse transform(MemcacheCommandResponse commandResponse) {
