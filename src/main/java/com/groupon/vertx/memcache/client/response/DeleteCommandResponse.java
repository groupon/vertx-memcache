...
/**
 * Represents a memcache delete response.
 *
...
public final class DeleteCommandResponse extends MemcacheCommandResponse {
    ...
    /**
     * Builder for the DeleteCommandResponse
     */
    public static class Builder extends AbstractBuilder<Builder, DeleteCommandResponse> {
        private String data;
