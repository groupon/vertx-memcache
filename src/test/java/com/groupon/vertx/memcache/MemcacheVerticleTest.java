...
/**
 * Tests for <code>MemcacheVerticle</code>.
 *
 * @author Stuart Siegrist (fsiegrist at groupon dot com)
 * @since 1.0.0
 */
public class MemcacheVerticleTest {
    @Mock
    private Vertx vertx;
    ...
    private MemcacheVerticle verticle;
    ...
    public void testStartValidConfig() {
        JsonObject config = new JsonObject("{\"memcacheConfig\":{\"servers\":[\"server\"],\"eventBusAddress\":\"address\"}}");
    ...
    public void testStartInvalidConfig() {
        JsonObject config = new JsonObject("{\"memcacheConfig\":{\"servers\":[\"foo\"]}}");
