...
/**
 * Tests for <code>ModifyCommandResponseCodec</code>.
 *
 * @author Stuart Siegrist (fsiegrist at groupon dot com)
 * @since 3.1.0
 */
public class ModifyCommandResponseCodecTest {
    private ModifyCommandResponseCodec codec;
    private ModifyCommandResponse command;

    @Before
    public void setUp() {
        codec = new ModifyCommandResponseCodec();
        command = new ModifyCommandResponse.Builder()
                .setData(1)
    ...
    public void testEncodeToWireAndDecodeFromWire() {
        ...
        ModifyCommandResponse endCommand = codec.decodeFromWire(0, buffer);
