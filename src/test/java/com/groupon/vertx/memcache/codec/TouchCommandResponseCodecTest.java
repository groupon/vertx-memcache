...
/**
 * Tests for <code>TouchCommandResponseCodec</code>.
 *
 * @author Stuart Siegrist (fsiegrist at groupon dot com)
 * @since 3.1.0
 */
public class TouchCommandResponseCodecTest {
    private TouchCommandResponseCodec codec;
    private TouchCommandResponse command;

    @Before
    public void setUp() {
        codec = new TouchCommandResponseCodec();
        command = new TouchCommandResponse.Builder()
                .setData("data")
    ...
    public void testEncodeToWireAndDecodeFromWire() {
        ...
        TouchCommandResponse endCommand = codec.decodeFromWire(0, buffer);
