...
/**
 * Tests for <code>RetrieveCommandResponseCodec</code>.
 *
 * @author Stuart Siegrist (fsiegrist at groupon dot com)
 * @since 3.1.0
 */
public class RetrieveCommandResponseCodecTest {
    private RetrieveCommandResponseCodec codec;
    private RetrieveCommandResponse command;

    @Before
    public void setUp() {
        codec = new RetrieveCommandResponseCodec();
        command = new RetrieveCommandResponse.Builder()
    ...
    public void testEncodeToWireAndDecodeFromWire() {
        ...
        RetrieveCommandResponse endCommand = codec.decodeFromWire(0, buffer);
